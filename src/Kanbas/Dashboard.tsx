...
import { /*fetchEnrollmentsForUser,*/ enrollInCourse, unenrollFromCourse } from "./client";
        ...
        updateEnrollment: (courseId: string, enrolled: boolean) => void}) 
    {
        ...
        return (
            <div id="wd-dashboard">
                ...
                <h2 id="wd-dashboard-published">Published Courses {courses.length/*courses.filter((course) => enrollments.some((enrollment) => enrollment.user === currentUser._id && enrollment.course === course._id)).length*/}</h2> <hr />
                        ...
                        {courses
                            ...
                            <div className="wd-dashboard-course col" style={{ width: "300px" }}>
                                ...
                                <Link className="wd-dashboard-course-link text-decoration-none text-dark"
                                    ...
                                    <img src={course.image ? course.image : '/images/React.jpg'}width="100%" height={160} alt="Course Logo"/>
